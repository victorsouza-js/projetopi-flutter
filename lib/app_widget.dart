...
import 'package:projeto_pi_flutter/pages/pagamento_page.dart' as pagamento;
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/pagamento': (context) => pagamento.PagamentoPage(),
          '/carrinho':
              (context) => CarrinhoPage(
                carrinho: [
                  ...
                  {
                    'nome':
                        'Suplemento em Pó Insane Clown 350g Demons Lab Tutti Frutii',
                    'preco': 109.05,
                    'imagem':
                  ...
                  {
                    'nome':
                        'Pré Treino Insane Clown Blue Vanilha 350g - Demons Lab',
                    'preco': 114.05,
                    'imagem':
